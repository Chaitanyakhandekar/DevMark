...
const Home = () => {
  ...
  return (
   <div className="h-[100vh] w-min-screen bg-white relative pt-10">
    {/* Navigation */}
    <nav className='w-full h-20 py-5 flex justify-between items-center fixed top-0 z-[55] bg-white dark:bg-[#111827] border-b-[0.2px] border-b-gray-800 bg-transparent backdrop-blur-md px-4 md:px-8'>
        {/* Logo */}
        ...
        <div className="text-black dark:text-white text-2xl sm:text-3xl font-bold">
          DevMark
        </div>
        </div>

        {/* Desktop Navigation Links */}
        <div className="hidden md:flex text-gray-600 dark:text-white gap-4 text-lg">
          <Link to="#" className="hover:text-[#4777f4] transition-colors duration-200">Features</Link>
          <Link to="#" className="hover:text-[#4777f4] transition-colors duration-200">Community</Link>
          <Link to="#" className="hover:text-[#4777f4] transition-colors duration-200">Pricing</Link>
          <Link to="#" className="hover:text-[#4777f4] transition-colors duration-200">About</Link>
        </div>
        ...
        <div className="hidden md:flex text-white justify-center items-center gap-5">
         <div
        onClick={handleTheme}
        className="border-[1.2px] border-gray-300 dark:border-gray-600 w-8 h-8 flex justify-center items-center rounded-md bg-white dark:bg-[#182231] cursor-pointer hover:scale-105 transition-transform duration-200">
          {
        ...
        <button className="rounded-md text-black dark:text-white text-lg hover:text-[#4777f4] transition-colors duration-200">Sign in</button>
        <button className="border-white rounded-md px-4 py-2 bg-gradient-to-r from-[#4777f4] to-[#9035ea] text-sm font-bold text-lg hover:scale-105 transition-transform duration-200">Get Started</button>
       </div>
       ...
       <div className="flex md:hidden items-center gap-3">
        ...
        className="border-[1.2px] border-gray-300 dark:border-gray-600 w-8 h-8 flex justify-center items-center rounded-md bg-white dark:bg-[#182231] cursor-pointer">
          {
            !isDark && <Moon className="text-gray-500" size={18}/>
          }
          {
            isDark && <Sun className="text-yellow-500" size={18}/>
          }
        </div>
        ...
        <button
          ...
          className="w-8 h-8 flex justify-center items-center text-black dark:text-white hover:text-[#4777f4] transition-colors duration-200"
    ...
    {isMobileMenuOpen && (
      <div className="fixed inset-0 z-[60] md:hidden">
        ...
        {/* Mobile Menu Content */}
        <div className="absolute top-20 left-0 right-0 bg-white dark:bg-[#111827] border-b border-gray-200 dark:border-gray-700 shadow-lg">
          <div className="flex flex-col py-4">
            {/* Navigation Links */}
            <Link 
              to="#" 
              className="px-6 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-[#4777f4] transition-colors duration-200 border-b border-gray-100 dark:border-gray-800"
              onClick={closeMobileMenu}
            >
              Features
            </Link>
            ...
            <div className="flex flex-col gap-3 px-6 pt-4">
              <button 
                className="w-full text-left py-3 text-gray-700 dark:text-gray-300 hover:text-[#4777f4] transition-colors duration-200"
                onClick={closeMobileMenu}
              >
                Sign in
              </button>
              <button 
                className="w-full py-3 px-4 bg-gradient-to-r from-[#4777f4] to-[#9035ea] text-white font-bold rounded-md hover:scale-105 transition-transform duration-200"
                onClick={closeMobileMenu}
              >
                Get Started
              </button>
