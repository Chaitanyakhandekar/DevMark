...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/user/search/tags/:tags" element={<ProtectedRoute><SearchTagsPage/></ProtectedRoute>}/>
      ...
      <Route path="/user/profile/:id" element={<ProtectedRoute><PublicProfilePage/></ProtectedRoute>} />
