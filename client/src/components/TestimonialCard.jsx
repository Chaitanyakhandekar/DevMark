...
function TestimonialCard({ testimonial }) {
  return (
      <div className="flex flex-col gap-3 justify-center items-start w-[93%] lg:w-[22%] min-w-[350px] h-[30%] min-h-[200px] max-h-[200px] max-w-[400px] bg-[#18212f] border-[0.1px] border-gray-700 rounded-2xl p-5">
